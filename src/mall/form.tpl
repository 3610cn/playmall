<!-- target: mallForm -->
<div class="crumb">
    <span class="title">| 购物中心管理 > <!-- if: ${formType} === 'create' -->新增<!-- else: -->编辑<!-- /if -->购物中心</span>
</div>
...
<div data-ui-id="form" data-ui-type="Form" data-ui-submit-button="submit" data-ui-auto-validate="true" class="container">
    <div class="form">
        ...
        <div class="row">
            <div class="field-name">购物中心名</div>
        ...
        <div class="row">
            <div class="field-name">购物中心logo</div>
        ...
        <div class="row">
            ...
            <div class="field-value">
                <div data-ui="type:Select;id:city;width:200;datasource:@cityList;value:@data.city;required:required;"></div>
            </div>
        </div>
